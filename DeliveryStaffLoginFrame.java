...
public class DeliveryStaffLoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(204, 243, 129));
        jLabel1.setText("Delivery Staff");

        jLabel2.setFont(new java.awt.Font("Rockwell", 1, 30)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 243, 129));
        jLabel2.setText("Login");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/yumxpress/images/staff_login.png"))); // NOI18N
        ...
        jLabel4.setForeground(new java.awt.Color(72, 49, 212));
        jLabel4.setText("Enter Email");

        jLabel5.setFont(new java.awt.Font("Rockwell", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(72, 49, 212));
        jLabel5.setText("Enter Password");

        btnLogin.setBackground(new java.awt.Color(72, 49, 212));
        btnLogin.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        btnLogin.setForeground(new java.awt.Color(204, 243, 129));
        ...
        btnBack.setBackground(new java.awt.Color(72, 49, 212));
        btnBack.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        btnBack.setForeground(new java.awt.Color(204, 243, 129));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtEmailId, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        if(!validateInputs()){
            JOptionPane.showMessageDialog(null, "Staff Name and Password fields cannot be left blank!");
            return;
        }
        try{
