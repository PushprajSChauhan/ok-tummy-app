...
public class OrderProductFrame extends javax.swing.JFrame {
    ...
    public OrderProductFrame(ProductPojo product){
        this(); //CONSTRUCTOR CHAINING KRKE PHLE BASIC TASK KRNE RHENGE BAAKI SARE FRAMES KI TARAH JO NON-PARAMETERISED CONSTRUCTOR KREGA
        this.product=product;
        loadProductDetails();
    }
    
    public OrderProductFrame(String productName,Double productPrice){
        this();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 64, -1, -1));

        jLabel3.setFont(new java.awt.Font("Goudy Old Style", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 231, 21));
        jLabel3.setText("Price");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 391, -1, -1));
        ...
        jPanel1.add(btnOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(479, 481, 123, 36));

        txtFoodName.setEditable(false);
        txtFoodName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtFoodName, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 123, 336, -1));

        txtPrice.setEditable(false);
        txtPrice.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(461, 390, 250, -1));
        jPanel1.add(lblFoodImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 175, 336, 186));
    ...
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        ...
        try{
            ...
            if(orderId==null){
                JOptionPane.showMessageDialog(null, "OOPS! Order was not placed");
                return;
            }
            ...
            JOptionPane.showMessageDialog(null, "Order is placed and email has been sent successfully to:"+UserProfile.getUserId());
            this.dispose();
            ...
            JOptionPane.showMessageDialog(null, "Error in sending mail in OrderProductFrame");
            ex.printStackTrace();
        }
