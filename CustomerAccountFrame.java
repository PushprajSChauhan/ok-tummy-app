...
public class CustomerAccountFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogout.setBackground(new java.awt.Color(16, 24, 32));
        btnLogout.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        btnLogout.setForeground(new java.awt.Color(254, 231, 21));
        ...
        btnCancelOrder.setForeground(new java.awt.Color(254, 231, 21));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(426, 13, -1, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 115, -1, -1));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 177, -1, -1));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 236, -1, -1));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 297, -1, -1));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 357, -1, -1));

        btnUpdate.setBackground(new java.awt.Color(254, 231, 21));
        btnUpdate.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        btnUpdate.setForeground(new java.awt.Color(16, 24, 32));
        ...
        jPanel1.add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(378, 479, 125, 36));
        ...
        jPanel1.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 479, 125, 36));

        txtPassword.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(491, 296, 290, -1));

        txtEmailId.setEditable(false);
        txtEmailId.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtEmailId, new org.netbeans.lib.awtextra.AbsoluteConstraints(491, 114, 290, -1));

        txtName.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(491, 176, 290, -1));

        txtMobileNo.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(491, 235, 290, -1));

        txtAddress.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jPanel1.add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(491, 356, 290, -1));
...
//            AB DATABASE MEI PASSWORD KO ENCRYPT KRKE BHEJENGE NA KI PLAIN TEXT JAISE
           ...
           boolean result=CustomerDAO.updateCustomer(customer);
            if(result){
                JOptionPane.showMessageDialog(null,"Customer Updation Completed Successfully!");
                clearAll();
                return;
            }
            JOptionPane.showMessageDialog(null,"Error in Customer Account Updation!");
        }
    ...
    private void loadCustomerDetailsById(String userId) {
        try{
            ...
            txtName.setText(customer.getCustomerName().trim());
            String password=PasswordEncryption.getDecryptedPassword(customer.getPassword());
            txtPassword.setText(password.trim());
            txtMobileNo.setText(customer.getMobileNo().trim());
            txtAddress.setText(customer.getAddress().trim());
        }
